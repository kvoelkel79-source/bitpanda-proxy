...
{"kurzanalyse":"2-3 Saetze warum und wohin","wahrscheinlichkeitSteigend":65,"wahrscheinlichkeitSeitwaerts":20,"wahrscheinlichkeitFallend":15,"kurszielPct":8.5,"stopLossPct":-4.5,"hauptrisiko":"kurzer Satz","hauptchance":"kurzer Satz","empfehlung":"KAUFEN oder ABWARTEN oder MEIDEN"}`;
...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    res.end(JSON.stringify({error:"Verfuegbar: /health /portfolio /scanner /prognose/:symbol /feargreed /debug /trades-debug"}));
